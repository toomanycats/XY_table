...
dim3_array = code_tools.ArrayTools().make_3d_array(config.X_length, config.Y_length, 
                                                     config.X_res,config.Y_res,config.Z_length)
motors = motor_tools.Main(config, dim3_array)
